<script lang="ts">
	...
	const sponsors = [
		{image: "https://github.com/Kaushalnar2688/daydream-aurora/blob/main/Screenshot%202025-09-18%203.52.06%20PM.png?raw=true", name: "Custom stickers provided by Jukebox", url: "https://www.jukeboxprint.com/custom-stickers", image: "/nyc/jukebox-logo.svg" }
	];
